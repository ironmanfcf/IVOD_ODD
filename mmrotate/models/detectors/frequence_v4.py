...
from ..mamba import MambaFusionBlock


"""""""""

尝试mamba的代码,参考自STTrack
...
class FrequenceDetV4(RotatedBaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(FrequenceDetV4, self).__init__(init_cfg)
        if pretrained:
    ...
    def extract_feat(self, img):
        ...
        for i in range(len(processed_feats)):
            fused_feature = self.MambaFusion(processed_feats_vis[i],processed_feats_ir[i])
