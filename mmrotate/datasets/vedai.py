...
class VEDAIDataset(CustomDataset):
    ...
    """
    CLASSES = ( 'van','camping_car','car','pick-up', 'truck','tractor', 'boat','vehicle', 'plane')
    ...
    def __init__(self,
        ...
        super(VEDAIDataset, self).__init__(ann_file, pipeline, **kwargs)
